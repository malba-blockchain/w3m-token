...
/**
 * @title W3M token over the Mumbai Network
 * @dev ERC20Pausable token with additional functionality.
 */
contract W3M is ERC20Pausable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("W3MToken", "W3M") Ownable() ReentrancyGuard() {
        ...
        // Setting the W3M token price to 0.006 USD with 8 decimals 10**8 (600,000)
        w3mPrice = 600000;

        // Setting the minimum investment allowed to buy W3M to $1 USD
        minimumInvestmentAllowedInUSD = 1 * 10 ** decimals();

        // Setting the maximum investment allowed to buy W3M to $10,000 USD
        maximumInvestmentAllowedInUSD = 10000 * 10 ** decimals();

        // Whitelister address
        whiteListerAddress = 0x00000000000000; //TO BE ADDED TO BE ADDED TO BE ADDED TO BE ADDED

        // Treasury address
        treasuryAddress = 0x00000000000000; //TO BE ADDED TO BE ADDED TO BE ADDED TO BE ADDED
