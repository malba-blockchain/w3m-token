 ...
 */
const deployWethToken: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  const wethToken = await hre.ethers.getContract("WethToken", deployer);
...
deployWethToken.tags = ["WethToken"];
